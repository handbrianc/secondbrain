...
SECONDBRAIN_PDF_ACCELERATOR_DEVICE=auto  # docling device: auto|cpu|mps|cuda|xpu; xpu = Intel iGPU/dGPU (needs torch XPU wheel + Level-Zero runtime; OCR stays CPU)
