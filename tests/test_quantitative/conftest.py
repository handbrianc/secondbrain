...
def _seed_test_data() -> None:
    ...
    try:
        ...
        # IMPORTANT: NO EMBEDDINGS HERE - embeddings are generated by worker fixtures
        # to avoid loading the model at master process level (causes meta tensor errors with xdist)
        test_chunks = [
            {
                ...
                # Embedding will be generated by worker fixture when needed
            },
            {
        ...
        # Insert test chunks WITHOUT embeddings - workers will generate them
