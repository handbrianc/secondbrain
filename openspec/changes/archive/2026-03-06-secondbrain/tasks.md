...
- [x] 2.4 Verify OpenAI-compatible API embeddinggemma model availability
- [x] 2.5 Document OpenAI-compatible API setup (local or Docker)
...
- [x] 7.2 Generate query embedding via OpenAI-compatible API
...
- [x] 11.4 Document Docker setup (MongoDB and OpenAI-compatible API)
