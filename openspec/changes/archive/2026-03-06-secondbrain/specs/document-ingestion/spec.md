...
- **AND** generates embeddings using OpenAI-compatible API
...
- **THEN** the system accepts: PDF, DOCX, PPTX, XLSX, HTML, Markdown, AsciiDoc, LaTeX, CSV, Images (PNG, JPEG, TIFF,
  BMP, WEBP), Audio (WAV, MP3), WebVTT, XML, Docling JSON
