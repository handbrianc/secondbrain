...
class MockLLMProviderWithContext(MockLLMProvider):
    ...
    def __init__(self) -> None:
        ...
        response_map = {
            ...
            "vector store": "Vector store connection errors occur when the Qdrant server is unreachable or the connection URL is invalid. Proper configuration helps prevent these connection errors. The Qdrant URL is configured using the SECONDBRAIN_QDRANT_URL environment variable.",
            ...
            "flow": "Data flow in SecondBrain goes from document ingestion through chunking, embedding generation, storage in Qdrant, and finally semantic search. This pipeline processes documents end-to-end.",
            ...
            "storage": "The Storage Layer uses Qdrant to store document chunks with their embeddings. This enables efficient vector similarity search.",
            # Generic fallback
