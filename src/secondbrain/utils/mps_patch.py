...
def patch_transformers_for_mps() -> None:
    ...
    try:
        ...
        original_func = modeling_rt_detr_v2.build_2d_sinusoidal_position_embedding
        ...
        # Apply patch
        modeling_rt_detr_v2.build_2d_sinusoidal_position_embedding = patched_build_2d_sinusoidal_position_embedding
