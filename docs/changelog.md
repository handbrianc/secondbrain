...
- **2026-08 / MongoDB → Qdrant + SQLite migration**: vector storage moved to Qdrant (`QdrantVectorStorage` +
  `StorageFactory`; chunk metadata in Qdrant payload), conversation sessions moved to SQLite (`ConversationStorage`),
  MongoDB/pymongo removed entirely.
...
[0.4.0]: https://github.com/handbrianc/secondbrain/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/handbrianc/secondbrain/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/handbrianc/secondbrain/compare/v0.1.0...v0.2.0
[0.1.0]: https://github.com/handbrianc/secondbrain/releases/tag/v0.1.0
