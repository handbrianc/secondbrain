...
This project is indexed by GitNexus as **secondbrain** (9001 symbols, 14247 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
