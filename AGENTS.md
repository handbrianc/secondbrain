...
This project is indexed by GitNexus as **secondbrain** (8417 symbols, 12822 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
